...
export default function Hero({ title, subtitle, children }) {
  return (
    <section className="relative min-h-[50vh] md:min-h-[70vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32 md:py-40 text-center">
        <motion.h1
        ...
        {subtitle && (
          <motion.p
            ...
            className="text-base sm:text-lg md:text-xl text-white/50 max-w-2xl mx-auto font-body"
          >
            {subtitle}
          </motion.p>
        )}
